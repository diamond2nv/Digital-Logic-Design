...
set_property PACKAGE_PIN V2 [get_ports {right[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {right[0]}]
set_property PACKAGE_PIN T3 [get_ports {right[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {right[1]}]
set_property PACKAGE_PIN T2 [get_ports {right[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {right[2]}]
set_property PACKAGE_PIN R3 [get_ports {right[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {right[3]}]
set_property PACKAGE_PIN W2 [get_ports {left[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {left[0]}]
set_property PACKAGE_PIN U1 [get_ports {left[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {left[1]}]
set_property PACKAGE_PIN T1 [get_ports {left[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {left[2]}]
set_property PACKAGE_PIN R2 [get_ports {left[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {left[3]}]
